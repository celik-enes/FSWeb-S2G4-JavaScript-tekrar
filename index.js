...
// 2. Tekrar eden sayılar için string oluştur ve diziye ekle
for (const sayi in tekrarSayilari) {
  if (tekrarSayilari[sayi] > 1) { // Sadece birden fazla tekrar edenleri al
    const mesaj = `${sayi} sayısı ${tekrarSayilari[sayi]} kere tekrar edilmiştir`;
